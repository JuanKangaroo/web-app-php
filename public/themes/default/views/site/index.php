<div class="container">
    <div class="row pt-5 pb-5">
        <div class="col text-center">
            ...
            <a href="/site/register" class="btn btn-primary btn-lg">Sign up Now!</a>
        </div>
    </div>

    <div class="row pt-5 pb-5">
        <div class="col text-center">
            <h3>Earn points for every litre of fuel you buy to heat your home*.</h3>
    ...
    <div class="row pt-5 pb-5">
        <div class="col-md-7">
            <h4>Sign up in-store or through our app</h4>
...
<div class="container-fluid">
    <div class="row pt-5 pb-5 bg-inverse">
        <div class="col text-center">
            <h1>Rewards You Want, at the Places You Love</h1>
            <br>
            <a href="/site/register" class="btn btn-primary btn-lg">Sign up Now!</a>
